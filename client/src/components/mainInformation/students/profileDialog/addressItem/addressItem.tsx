...
const AddressItem: React.FC<AddressItemProps> = ({ student, setAddresses }) => {
    ...
    // Chỉ cập nhật khi địa chỉ thay đổi
    useEffect(() => {
        if (student) {
            setPermanentAddress(student.dia_chi_thuong_tru || defaultAddress);
            setTemporaryAddress(student.dia_chi_tam_tru || defaultAddress);
        }
    }, [student]);
    ...
    return (
        <div>
            <LocationSelect
                label="Địa chỉ thường trú"
                onAddressChange={setPermanentAddress}
            ...
            <input
                ...
                placeholder="Địa chỉ thường trú"
                className="address-item-input"
                value={`${permanentAddress.chi_tiet}, ${permanentAddress.phuong_xa}, ${permanentAddress.quan_huyen}, ${permanentAddress.tinh_thanh_pho}`}
            />
            ...
            <LocationSelect
                label="Địa chỉ tạm trú"
                onAddressChange={setTemporaryAddress}
            ...
            <input
                ...
                placeholder="Địa chỉ tạm trú"
                className="address-item-input"
                value={`${temporaryAddress.chi_tiet}, ${temporaryAddress.phuong_xa}, ${temporaryAddress.quan_huyen}, ${temporaryAddress.tinh_thanh_pho}`}
            />
        </div>
    );
};
