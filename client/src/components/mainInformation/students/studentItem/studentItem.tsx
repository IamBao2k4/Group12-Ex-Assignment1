...
const StudentItem: React.FC<StudentItemProps> = ({ id, student, ProfileHandler, setChosenStudent, onDeleteSuccess }) => {
    ...
    async function DeleteStudentHandler() {
        try {
            ...
            if (response.ok) {
                showNotification('success', `Student "${student.ho_ten}" deleted successfully`);
            ...
            <div className="student-item row" key={id}>
                <div className="student-item-info">
                    ...
                    <div className="student-item-action">
                        ...
                        <button className="student-item-action-delete" onClick={deleteConfirmHandler}><DeleteIcon /></button>
                    </div>
                </div>
            </div>
        </>
